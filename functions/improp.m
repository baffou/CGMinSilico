...
% dx and dy shift the pattern of the image by dx and dy pixels
%  (not necessarily integers), as a means to render the effect of a tilted
%  illumination.
...
dxSize = period/size(M,1); % camera dexel size
